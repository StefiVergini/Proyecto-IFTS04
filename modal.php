...
<body>
  ...
  <div class="container-modal">
    <div class="content-modal">
      <h2> Bienvenido </h2>
      <!-- <a class="adm" href="administrador.php">* Área administrativa.</a> -->
      ...
      <p>También, le dejamos a disposición los números habilitados para atención administrativa: <br>
        Celular; 11 xxxx-xxxx<br>
        Tel. linea; xxxx-xxxx</p>
      <h1><a href="infoInstitucional.php">Enlace Informativo</a></h1>
