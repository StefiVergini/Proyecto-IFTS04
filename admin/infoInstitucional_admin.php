        ...
        <table class="tablaInicio" id="table_id">
          <tbody>
            ...
            if (isset($_GET['from_date']) && isset($_GET['to_date'])) {
              ...
              $query = "SELECT user.nombre_area, user.mensaje,
                                    user.fecha_publicacion, user.estado, permisos.rol FROM user
                                    LEFT JOIN permisos ON user.rol = permisos.id WHERE fecha_publicacion BETWEEN '$from_date' AND '$to_date' ";
            ...
            ?>
              <h3 class="volver">
                <a class="pPrincipal" href="../admin/index.php">╚► Volver Página Principal</a>
              </h3>
      </div>
</body>
